                        ...
                        implements AShape
{
     ...
     * @param arcY int arc height
     */
    public ARoundRectangle( int x, int y, int w, int h, int arcW, int arcY )
    {
        this.setRoundRect( x, y, w, h, arcW, arcY );
        this.setColor( defaultColor );
    }
     ...
     * setArcSize( double, double ).
     * 
     * @param arcWidth double arc width
     * @param arcHeight double arc height
     */
    public void setArcSize( double arcWidth, double arcHeight )
    {
        this.setRoundRect( this.getXLocation(), this.getYLocation(),
                           this.getWidth(), this.getHeight(), arcWidth,
                           arcHeight );
    }
