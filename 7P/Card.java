                  ...
                  implements Comparable<Card>, MouseListener, Geometry
{
    ...
    //--------------------- setNode( PyramidNode ) --------------------
    /**
     * Identify the PyramidNode (for PyramidSolitaire) that this card is in.
     * 
    ...
    //--------------------- getNode() --------------------
    /**
     * Return the PyramidNode (for PyramidSolitaire) that this card is in.
     * 
    ...
    //--------------------- mousePressed --------------------------
    /**
     * mousePressed -- attempted play of the card.
     * 
     * @param e MouseEvent
     */ 
    ...
    //-------------------------- toString -------------------------
    /**
     * Generate a String representing this Card.
     * 
     * @return String
     */ 
    ...
    //------------------- main unit test ------------------------------
    /**
     * A very basic unit test for the Card.
     * 
