 ...
 * Last modified: rdb 01/22/13 to make SnowMan an AShape and to use 
 *                an ArrayList
 */
import java.awt.*;
import java.util.*;

public class SnowMan implements AShape
{
    //---------------- instance variables ------------------------------
    ...
    {
        // create the list to hold all the A-components of the SnowMan
        ...
        // create the head
        AEllipse head = new AEllipse( x + headX, y + headY );
        head.setSize( headSize, headSize );
        head.setFillColor( Color.WHITE );
        aObjects.add( head );
        
        // create the two eyes
        AEllipse leftEye = new AEllipse( x + leftEyeX, y + leftEyeY );
        ...
        {
            smilePart = new ALine( Color.BLACK );
        ...
        ARectangle hatBody = new ARectangle( x + hatX, y + hatY );
        hatBody.setSize( hatW, hatH );
        hatBody.setColor( Color.BLACK );
        aObjects.add( hatBody );
        
        ARectangle hatBrim = new ARectangle( x + brimX, y + brimY );
