/**
 * AMovableEllipse.java: Draggable version of AEllipse
...
public class AMovableEllipse extends AEllipse implements AMovableShape
{
    //---------------- instance variables ------------------------
     ...
     */
    public AMovableEllipse( Color aColor )
    { 
        this( 0, 0 );
        setColor( aColor );
    }
     ...
     */
    public AMovableEllipse( int x, int y )
    {
        super( x, y );
        _draggable = true;
        _animated  = false;
